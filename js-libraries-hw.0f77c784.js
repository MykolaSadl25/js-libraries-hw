...
window.addEventListener("keydown", (0, _debounceDefault.default)((e)=>{
    if (e.key !== keys[currentKeyIndex]) (0, _pnotifyJs.error)({
        ...
        if (currentKeyIndex !== keys.length - 1) currentKeyIndex++;
        else if (currentKeyIndex === keys.length - 1) (0, _pnotifyJs.notice)({
